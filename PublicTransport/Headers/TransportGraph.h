...
class TransportGraph
{
	...
	std::pair<unsigned, unsigned> calculateDynEdgeWeightShortestTime(unsigned startTime, unsigned currTime, unsigned currBusTakenNumber, unsigned nextBusNumber, const std::string& currBusStopName, const std::string& nextBusStopName);
	std::pair<unsigned, unsigned> calculateDynEdgeWeightMinBusesTaken(unsigned currBusTakenNumber, unsigned nextBusNumber);
	std::pair<unsigned, unsigned> calculateDynEdgeWeightMinTimeSpent(unsigned currTime, unsigned currBusTakenNumber, unsigned nextBusNumber, const std::string& currBusStopName, const std::string& nextBusStopName);
...
public:
	...
	unsigned findShortestTimeBetweenBusStops(std::string& startBusStop, std::string& endBusStop, unsigned startTime, std::vector<vertexAndDistancePair>& path);
	unsigned findMinBusesTakenPath(std::string& startBusStop, std::string& endBusStop, std::vector<vertexAndDistancePair>& path);
	unsigned findMinTimeSpentOutsideVehiclePath(unsigned startTime, std::string& startBusStop, std::string& endBusStop, std::vector<vertexAndDistancePair>& path);
	...
	bool checkBusStopExistence(const std::string& busStopName);
